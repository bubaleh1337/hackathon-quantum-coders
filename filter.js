...
function searchResult(element) {
  list.innerHTML += `
        ...
        <div>
        <h5 class="search__card-title card-title">${element.name}</h5>
        <div class="search__card-subtitle"></div>
        <div class="search__card-experience">${element.area}</div>
        <div class="search__card-subtitle">Цена</div>
...
document.addEventListener("DOMContentLoaded", async function () {
  let url = "https://001smiling.github.io/filt/posts4.json";
